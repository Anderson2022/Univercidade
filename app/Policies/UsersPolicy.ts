...
export default class UsersPolicy extends BasePolicy {
  ...
  public async view(user: User) {
    return await this.hasPermission(user, 'list_user')
  }
  public async create(user: User) {
    return await this.hasPermission(user, 'create_user')
  }
  public async update(user: User) {
    return await this.hasPermission(user, 'update_user')
  }
  public async delete(user: User) {
    return await this.hasPermission(user, 'delete_user')
  }
