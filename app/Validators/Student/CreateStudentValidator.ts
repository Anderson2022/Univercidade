...
export default class CreateStudentValidator {
  ...
  public schema = schema.create({
    ...
    name: schema.string({}),
    cpf: schema.string({}, [rules.minLength(11), rules.unique({ table: 'students', column: 'cpf' })]),
    dateOfBirth: schema.date({format:'dd/MM/yyyy'}),
    phone: schema.string({}, [rules.minLength(11), rules.unique({ table: 'students', column: 'phone' })]),
